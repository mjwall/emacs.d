...
(custom-set-variables
 ...
 ;; If there is more than one, they won't work right.
  ...
  '(package-selected-packages
     (quote
       (spacemacs-theme solarized-theme solarized leuven-theme zenburn-theme ample-zen-theme ample-zen clojure-mode scala-mode gradle-mode cmake-mode thrift-mode octave-mode company-mode py-autopep8 ein lsp-python conda anaconda-mode ng2-mode lsp-javascript-typescript eglot typescript-mode dap-mode lsp-java lsp-ui company-lsp lsp-mode yasnippet idomenu dired-sidebar use-package))))
